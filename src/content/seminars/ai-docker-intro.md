...
```bash
# Ollama로 Llama 3 로컬 실행
docker run -d -p 11434:11434 ollama/ollama
```

Stable Diffusion, Whisper, Hugging Face의 대부분 모델은 도커 이미지로 배포됩니다. 도커를 모르면 최신 AI 모델을 못 돌립니다.
